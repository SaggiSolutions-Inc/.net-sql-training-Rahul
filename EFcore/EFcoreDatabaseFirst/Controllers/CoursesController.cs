...
namespace EFcoreDatabaseFirst.Controllers
{
    public class CoursesController : Controller
    {
        ...
        {
            var studentDbContext = _context.Courses.Include(c => c.Instructor);
        ...
        public async Task<IActionResult> Create([Bind("CourseId,CourseName,Credits,InstructorId")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CourseId,CourseName,Credits,InstructorId")] Course course)
        {
